...
This Module/Script can help to Count reads number of each miRNA and its isomiR.
...
if __name__=="__main__":
    if len(sys.argv)==1:
        print "Usage: "+sys.argv[0]+"  miRBaseRelease18/hsa/human_maturemiRNA.bed miRBaseRelease18/hsa/trimed_1726_hsamiRNA.txt > miRBaseRelease18/hsa/trimed_1726_hsamiRNA_total.txt"
    else:
        fh=open(sys.argv[1])
