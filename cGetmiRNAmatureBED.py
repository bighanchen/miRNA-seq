...
This Module/Script can help to get miRNA mature sequence in BED format.
...
if __name__=="__main__":
    if len(sys.argv)==1:
        print "Usage: "+sys.argv[0]+" miRBaseRelease18/hsa/hsa.bed miRBaseRelease18/hsa/miRNAFromdat.txt > miRBaseRelease18/hsa/human_maturemiRNA.bed"
    else:
        fh=open(sys.argv[1])
        start={}
        end={}
